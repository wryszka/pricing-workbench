...
import { Database, Zap, Clock, ExternalLink, CheckCircle2, AlertTriangle, Tag } from 'lucide-react';
...
export default function FeatureStore() {
  ...
  useEffect(() => {
    api.getFeatureStoreStatus().then(setData).finally(() => setLoading(false));
  }, []);
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8">
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">Unified Pricing Table — offline and online feature serving</p>
      </div>
